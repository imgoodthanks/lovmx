...
defmodule Player do
  ...
  #   #Holo.orbit "Player::grab:bot:#{inspect player}"
  #
  ...
  #   #Holo.orbit "Player.handle_call::grab: #{nubspace} (#{inspect source})"
  #
  ...
  #   #Holo.orbit "Player::grab:nubspace:#{inspect player}"
  #
  #   #GenServer.call(PlayerServer, {:loot, player})
  # end
  # def handle_call({:loot, player}, source, computer) do
  #   ###Holo.orbit "Player.handle_call:::loot: #{inspect player} (#{inspect computer})"
  #
  #   #todo: grab stuff
  #
